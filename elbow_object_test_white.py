...
def sensor_thread_loop():
    ...
    while running:
        # We only care about the right sensor for this test
...
def main_loop():
    ...
    try:
        # Phase 1: Wait for a valid initial wall reading BEFORE moving at all
        ...
        while not object_found:
            ...
            # We have an initial baseline, check for sudden drops indicating an object
            ...
            # Bottom half check (Line Tracking - No Front Obstacle Check)
            roi_start = h // 2
